...
from models.dino_multiscale_parallel_classifier import DinoMultiScaleClassifier
...
def main():
    ...
    ap.add_argument("--out", default="runs_dino_multiscale_parallel")
    args = ap.parse_args()
    ...
    out_dir = Path(args.out) / args.dataset / "dino_multiscale_parallel"
